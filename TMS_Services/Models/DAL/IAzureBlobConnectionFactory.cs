...
namespace TMS_Services.Models.DAL
{
    ...
    public class AzureBlobConnectionFactory : IAzureBlobConnectionFactory
    {
        ...
        private CloudBlobClient GetClient()
        {
            ...
            var storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=uploadedfiles;AccountKey=M8vvc5JGmOKZWMYiW8qFOMmloZM9GuhShPcNwCSZWNxYStzhLeRPL1DbgjpApua76GoobasudU51mdqNB5Xt7A==;EndpointSuffix=core.windows.net";
